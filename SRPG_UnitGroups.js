...
(function() {
  ...
  var parameters = $plugins.filter(function (plugin) { return plugin.description.contains('SRPG_UnitGroups'); });
  var parameters = PluginManager.parameters("SRPG_UnitGroups");
