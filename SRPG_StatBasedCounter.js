 ...
 * @author Dr. Q (dopan edited version for srpgUnitCore)
 *
 ...
 *----------------------------------------------------------------------------
 *
 * -> dopan Edit for more Enemy Notes if using srpgUnitCore & having enemyEquipment 
 *
 * this enables counterskill note for enemys the same way as it works for actors
 * (means related to equip&class aswell, the srpgUnitCore adds Equip&Classes to Enemys) 
 * -> srpgStatbasedCounter was made before the srpgUnitCore, thats why this edit is added.
 *
 *
 */
...
// dopan edited function for more possible Notes, used with srpg UnitCore.
