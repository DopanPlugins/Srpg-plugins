...
(function() {
  ...
  var parameters = $plugins.filter(function (plugin) { return plugin.description.contains('SRPG_EnemyUnits'); });
  var parameters = PluginManager.parameters("SRPG_EnemyUnits");
