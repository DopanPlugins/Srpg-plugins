 ...
 *
 * 
 * PLUG & PLAY (this is for 1110x768 Usage)
 *
 *
 *
 *
...
//-----------------------------------------------------------------------------------------
    ...
    Window_SrpgPrediction.prototype.drawContents = function() {
        ...
        this.drawText('Crit', windowWidth / 2 + x + 160, lineHeight * 2);
        this.resetTextColor();
        this.drawText(actorCrit + '%', windowWidth / 2 + x + 220, lineHeight * 2);
        // draw default content
        this.drawSrpgBattleActionName(actor, action, windowWidth / 2 + x - 40, lineHeight * 0, true);
        this.drawSrpgBattleHit(hit, eva, windowWidth / 2 + x - 40, lineHeight * 1);
...
//-----------------------------------------------------------------------------------------
    ...
    Window_SrpgPrediction.prototype.drawChances = function(action, x) {
           ...
           this.drawText('Steal', this.windowWidth() / 2 + x + 260, this.lineHeight() * 3);
           this.resetTextColor();
        ...
        if (skill.meta.srpgSteal || skill.meta.srpgItemSteal || skill.meta.srpgTypeStealWeapon || skill.meta.srpgTypeStealArmor || 
           ...
           this.drawText(textSteal + '%', this.windowWidth() / 2 + x + 340, this.lineHeight() * 3);
    };
...
Scene_Map.prototype.createSrpgBattleWindow = function() {
     ...
     this._mapSrpgBattleWindow.y = this._mapSrpgStatusWindow.windowHeight() + this._mapSrpgPredictionWindow.windowHeight();// - 160
